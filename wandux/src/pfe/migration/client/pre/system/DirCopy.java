...
//								+ " to: " + newPath + File.separator);
					...
					//RECURSE through other directories
						...
						CopyRec(oldPath + File.separator + oldFiles[i],	newFileLocation);
					}
				} catch (Exception e) {
		...
		public static void SimpleCopy(String old_path, String new_path) {
			//create file objects from method parameters
			File oldPath = new File(old_path);
			File newPath = new File(new_path);

			System.out.println("old: "+old_path);
...
//									+ " to: " + newPath + File.separator);
							...
							FileInputStream in = new FileInputStream(inputFile);
							FileOutputStream out = new FileOutputStream(outputFile);
							System.out.println("my_in::"+inputFile);
							System.out.println("my_out::"+outputFile);
							//read and write bytes from old file to new file
							byte[] b = new byte[1024];
							int readBytes;
						...
						//RECURSE through other directories
							...
							String newFileLocation = outputFile.toString();
							SimpleCopy(oldPath + File.separator + oldFiles[i],
									newFileLocation);
							System.out.println("cp: " + oldPath + File.separator + oldFiles[i]);
						}
					} catch (Exception e) {
						//System.out.println("TODO");
						//do whatever here
